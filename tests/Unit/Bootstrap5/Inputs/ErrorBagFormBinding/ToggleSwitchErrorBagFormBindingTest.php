...
class ToggleSwitchErrorBagFormBindingTest extends TestCase
{
    /** @test */
    public function it_can_override_toggle_switch_form_error_bag_binding_from_component_error_bag(): void
    {
